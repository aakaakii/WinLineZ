...
static RenderTexture2D brightnessTarget = {0};
static RenderTexture2D hBlurTarget[2] = {{0}, {0}};  // 双缓冲 ping-pong
static RenderTexture2D vBlurTarget[2] = {{0}, {0}};

static Shader brightnessExtractShader = {0};
static Shader gaussianBlurShader = {0};
static Shader bloomCompositeShader = {0};
